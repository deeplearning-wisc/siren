...
class DefSetCriterion_owdetr(nn.Module):
    ...
    def __init__(self, args, num_classes, matcher, weight_dict, losses, focal_alpha=0.25):
        ...
        self.nc_epoch = 9#args.nc_epoch
        self.output_dir = args.output_dir
        self.invalid_cls_logits = None
        self.unmatched_boxes = True#args.unmatched_boxes
        self.top_unk = 5#args.top_unk
        self.bbox_thresh = 0.3#args.bbox_thresh
        self.num_seen_classes = 20#args.PREV_INTRODUCED_CLS + args.CUR_INTRODUCED_CLS
